...
import static diarsid.beam.server.services.domain.validation.ValidationResultImpl.validationFailsWith;
import static diarsid.beam.server.services.domain.validation.ValidationResultImpl.validationOk;
...
@Component
public class WebObjectsPropertiesValidator implements WebObjectsValidationService {
