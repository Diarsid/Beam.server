...
import static diarsid.beam.server.services.auth.JwtStatus.JWT_EXPIRED;
import static diarsid.beam.server.services.auth.JwtStatus.JWT_NOT_FOUND;
import static diarsid.beam.server.services.auth.JwtStatus.JWT_SIGN_INVALID;
