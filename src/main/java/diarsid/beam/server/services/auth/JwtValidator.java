...
import static diarsid.beam.server.services.auth.JwtStatus.JWT_LEGAL;
import static diarsid.beam.server.services.auth.JwtValidationResult.jwtExpired;
import static diarsid.beam.server.services.auth.JwtValidationResult.jwtNotFound;
import static diarsid.beam.server.services.auth.JwtValidationResult.jwtSignFailed;
