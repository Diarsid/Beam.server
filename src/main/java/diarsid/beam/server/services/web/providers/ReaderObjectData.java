...
public class ReaderObjectData implements MessageBodyReader<ObjectData> {
    
    private final JsonToJavaObjectConverter converter;
    
    public ReaderObjectData(JsonToJavaObjectConverter converter) {
    ...
    public ObjectData readFrom(
        ...
        return (ObjectData) this.converter.objectivize(entityStream, ObjectData.class);
    }
}
