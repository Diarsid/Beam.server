...
import static diarsid.beam.server.domain.services.jwtauth.JwtStatus.JWT_EXPIRED;
import static diarsid.beam.server.domain.services.jwtauth.JwtStatus.JWT_LEGAL;
import static diarsid.beam.server.domain.services.jwtauth.JwtStatus.JWT_NOT_FOUND;
import static diarsid.beam.server.domain.services.jwtauth.JwtStatus.JWT_SIGN_INVALID;
