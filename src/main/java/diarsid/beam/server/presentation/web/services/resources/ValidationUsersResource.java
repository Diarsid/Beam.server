...
public class ValidationUsersResource {
    ...
    static {
        logger = LoggerFactory.getLogger(ValidationUsersResource.class);
    }
    
    private final UsersValidationService validationService;
    private final UsersService usersService;
    
    public ValidationUsersResource(UsersValidationService validation, UsersService usersService) {
